<template>
  <div class="posts">
      ...
      <div v-for="post in postss" :key="post.id">
...
export default {
    ...
    data() {
        return {
            ...
            body: '',
            postss:[
              {id: 1, title: 'Some text post 1', body: 'and Some text post 1'},
              {id: 2, title: 'Some text post 2', body: 'and Some text post 2'},
              {id: 3, title: 'Some text post 3', body: 'and Some text post 3'},
            ],
        }
    },
    methods: {
